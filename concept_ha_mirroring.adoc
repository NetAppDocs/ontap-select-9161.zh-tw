...
具有調解器的雙節點叢集可以跨越兩個資料中心。有關更多信息，請參閱link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["雙節點擴展 HA (MetroCluster SDS) 最佳實踐"] 。
