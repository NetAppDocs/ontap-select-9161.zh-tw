...
REST 由 Roy Fielding 在他的博士論文中正式提出 https://www.ics.uci.edu/~fielding/pubs/dissertation/top.htm["論文"] 2000年在加州大學歐文分校獲得。它透過一系列約束定義了一種架構風格，這些約束共同改進了基於Web的應用程式及其底層協定。這些約束基於客戶端/伺服器架構，使用無狀態通訊協議，建構了一個RESTful Web服務應用程式。
